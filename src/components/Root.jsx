...
function Root() {
  ...
  return (
    <div className='container mx-auto flex items-center justify-center flex-col py-12 gap-8'>
            ...
            <img src={imageUrl==='/' ? defImg : imageUrl} alt="defimg" className='w-full sm:w-1/2 rounded-3xl' />

            <div className='flex justify-center items-center gap-2 mt-2 '>
                <input ref={inputRef} type="text" className='outline-none rounded-full p-3 w-[300px] sm:w-[500px] h-[40px] sm:h-[60px] text-[18px]' placeholder='What do you want to see...'/>
                <button onClick={() => handleSubmit()} className='border-2 rounded-3xl p-2 border-[purple] bg-[purple]'>
                    <img className='w-5 sm:w-8' src={zsearch} alt="search" />
                </button>
            </div>
